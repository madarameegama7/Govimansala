  ...
  return (
    <>
            ...
            <div className="deal-card" key={index}>
              ...
              <div className="deal-info">
                ...
                <div className="badge-row">
                  ...
                  <span className="badge">{index === 1 ? 'Hot Deals' : 'Limited Time'}</span>
                </div>
      ...
      <div className="how-it-works">
        <h2>How It Works</h2>
        <p className="how-subtitle">Three simple steps to start sourcing fresh farm products for your business</p>
        <div className="steps">
          <div className="step">
            <i className="fas fa-user-plus"></i>
            <h4>1. Register</h4>
            <p>Create your wholesale buyer account to access pricing and place orders</p>
          </div>
          <div className="step">
            <i className="fas fa-search"></i>
            <h4>2. Browse</h4>
            <p>Explore our marketplace to find fresh, local produce from trusted farmers</p>
          </div>
          <div className="step">
            <i className="fas fa-shopping-basket"></i>
            <h4>3. Order</h4>
            <p>Place your order and get fresh produce delivered directly to your business</p>
          </div>
        </div>
      </div>
    </>
