...
const OrderDashboard = () => {
  ...
  const [orders, setOrders] = useState([
    {
      ...
      locations: [
        {
          ...
          address: '45 Maharagama Road, Colombo',
          coordinates: { lat: 6.8431, lng: 79.9269 },
          distance: 5.2, // Nearest to starting point
          farmType: 'organic',
        ...
        },
        {
          ...
          address: '128 Nugegoda Main Street, Nugegoda',
          coordinates: { lat: 6.8649, lng: 79.8997 },
          distance: 8.7, // Second nearest
        ...
        },
        {
          ...
          address: '67 Pannipitiya Road, Pannipitiya',
          coordinates: { lat: 6.8416, lng: 79.9609 },
          distance: 12.3, // Third pickup location
          farmType: 'organic',
          contactPhone: '+94 75 555 7890'
        },
        {
          type: 'delivery',
          name: 'Kamatha Restaurant',
          address: '234 Galle Road, Bambalapitiya, Colombo 04',
          coordinates: { lat: 6.8896, lng: 79.8570 },
          distance: 15.8, // From last pickup to restaurant
          businessType: 'restaurant',
          deliveryInstructions: 'Use service entrance at back. Ask for Chef Kumar.'
        }
      ],
      products: [
        { 
        ...
        { 
          ...
          quantity: '70 kg', 
          price: 9800, 
          location: 'Golden Valley Agriculture',
          variety: 'Beefsteak Tomatoes',
          quality: 'Grade A' 
        },
        { 
          name: 'Fresh Tomatoes', 
          quantity: '50 kg', 
          price: 7500, 
          location: 'Fresh Harvest Cooperative',
      ...
      subtotal: 33050,
      deliveryFee: 1200,
      totalWithDelivery: 34250,
      totalDistance: 42.0,
      totalWeight: '225 kg',
      estimatedTime: '2h 45min',
      specialInstructions: 'Handle tomatoes with care - restaurant quality required. Deliver to service entrance. Total order: 200kg tomatoes + 25kg onions. Check quality with Chef Kumar before unloading.'
    },
    {
      id: 2,
      ...
      products: [
        { name: 'Banana', quantity: '2 dozen', price: 600, location: 'Sunshine Vegetables', variety: 'Cavendish' },
        { name: 'Pineapple', quantity: '1 piece', price: 450, location: 'Sunshine Vegetables', variety: 'Sweet Golden' }
      ],
      subtotal: 1050,
      deliveryFee: 180,
  ...
  // Calculate optimized route with real distance calculations
  const optimizeRoute = (locations) => {
    ...
    // Starting point (driver's current location - assume first pickup for now)
    const startPoint = pickups.length > 0 ? pickups[0].coordinates : { lat: 6.9271, lng: 79.8612 };
    
    // Calculate distances from starting point to each pickup location
    ...
    // Return optimized route: nearest pickups first, then deliveries
  ...
  const handleStartNavigation = (orderId) => {
    ...
    if (order) {
      ...
      // Navigate to the navigation page with order data
